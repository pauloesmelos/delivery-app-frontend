import { FaSeedling, FaShieldAlt, FaShoppingBag } from "react-icons/fa";
...
export const data = [
    {
      ...
      price: '$$$$',
      amount: 49.99,
      restaurant: "Hamburgueria Mineira",
      date: "19/11/2024",
      delivery: true,
      online: true
    },
    ...
    },
    {
      ...
      price: '$$',
      amount: 33.00,
      restaurant: "Cantinho Brazillian",
      date: "19/11/2024",
      delivery: true,
      online: false
    },
    ...
    },
    {
      ...
      price: '$$',
      amount: 25.99,
      restaurant: "We Deliver Desserts Too",
      date: "20/11/2024",
      delivery: false,
      online: true
    },
  ...
  export const headlineItems = [
    {
      id: 0,
      restaurant: "Sun's Out, BOGO's Out",
      inclusionDate: "18/11/2024",
